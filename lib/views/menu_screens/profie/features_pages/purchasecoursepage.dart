...
import 'package:lmsapp/views/menu_screens/profie/features_pages/landingpages/purchasedcourselandingpage.dart';
      ...
      builder: (context, main, child) {
        return Scaffold(
          ...
          body: main.loadingmycourses == true
              ...
              : main.mycourse?.data?.isEmpty ?? true
                  ? Center(
                      child: Text(
                        'No Purchase Course !!!',
                          ...
                          if (currentstate == 1)
                            Expanded(
                              child: main.loadingupcomingtest == true
                                  ...
                                  : GridView.builder(
                                      itemCount: main.upcomingtest?.data
                                              ?.allTest?.length ??
                                          0,
                                      gridDelegate:
                                      ...
                                      itemBuilder: (context, index) {
                                        var data = main.upcomingtest?.data
                                            ?.allTest?[index];
