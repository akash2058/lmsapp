...
class CourseLandingPage extends StatefulWidget {
  String id;
  CourseLandingPage({super.key, required this.id});

  @override
  State<CourseLandingPage> createState() => _PopularCourseLandingPageState();
}

class _PopularCourseLandingPageState extends State<CourseLandingPage> {
  @override
  void initState() {
    super.initState();
      ...
      builder: (context, get, child) {
        ...
        return Scaffold(
          bottomNavigationBar: BottomAppBar(
            ...
            child: Row(
              children: [
                get.loadingcoursedetails == true
                    ? LoadingAnimationWidget.staggeredDotsWave(
                        color: AppColors.primaryblack, size: 20.h)
                    : Text(
                        '₹${get.course?.data?.course?.salePrice ?? '0'}',
                        style: titlestyle,
                      ),
                SizedBox(
                  width: 20.w,
                            ...
                            child: Column(
                              ...
                              children: [
                                CourseDetailCard(
                                  ...
                                  title: get.course?.data?.course?.title ?? '',
                                  ...
                                  ratings:
                                      '${get.course?.data?.reviews?.length.toString() ?? ''}/5',
                                  img:
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) {
                                      ...
                                      return CustomExpansionTile(
                                        ...
                                        children: data?.videoContent?.isEmpty ??
                                                true
                                            ? [
